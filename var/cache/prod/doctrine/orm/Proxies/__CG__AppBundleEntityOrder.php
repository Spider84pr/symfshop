...
class Order extends \AppBundle\Entity\Order implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Order' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Order' . "\0" . 'orderDate', '' . "\0" . 'AppBundle\\Entity\\Order' . "\0" . 'user', '' . "\0" . 'AppBundle\\Entity\\Order' . "\0" . 'cart'];
        }
    ...
    public function setCart($crt)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCart', [$crt]);

        return parent::setCart($crt);
    }
